...
public class AppConstants {
    ...
    public static final String SMC_ROLL_ID = "15";
    public static final String CDMA_ROLL_ID = "19";
    public static final String ULB_ROLL_ID = "5";
    public static final String MC_ROLL_ID = "14";
